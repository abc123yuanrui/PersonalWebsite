    ...
    render(){
        return (<div>
            ...
            <div>
                ...
                and a generative adversarial network (GAN) based model to produce synthetic data. The quality of the dataset was assessed and validated through qualitative inspection and three methods: empirical statistics, metrics based on information theory, and evaluation metrics based on machine learning techniques. <a href='https://engineeringcommunity.nature.com/posts/exploring-future-smart-grid-residential-electricity-usage-with-a-synthetic-dataset-of-danish-electricity-prosumers' target="blank">blog of 'behind the paper' in Nature community</a>. </p>
                ...
                <p className="myP">Published by Australasian Universities Power Engineering Conference (AUPEC2022)</p>
