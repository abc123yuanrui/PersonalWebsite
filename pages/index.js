    ...
    render(){
        return (<div>
            ...
            <div>
                ...
                <p className="myP">Published by Nature <a href='https://www.nature.com/articles/s41597-023-02271-3' target="blank">Scientific Data</a> (IF: 8.4)</p>
                ...
                and a generative adversarial network (GAN) based model to produce synthetic data. The quality of the dataset was assessed and validated through qualitative inspection and three methods: empirical statistics, metrics based on information theory, and evaluation metrics based on machine learning techniques. <a href='https://rdcu.be/dd2sr' target="blank">epdf</a>. </p>
